...
import { CardSuccessfulScreenProp } from '../../typings/types';

const CardSuccessful: React.FC<CardSuccessfulScreenProp> = ({ navigation }) => {
      ...
      <View style={styles.container}>
        <ScrollView>
          ...
          <View style={styles.mainContainer}>
            ...
            {!isMobileDevice() && <TotalAmount items={details} addPhoneScreen='CardPhone' />}
          </View>

          {isMobileDevice() && (
            <View style={styles.amountContainer}>
              <TotalAmount items={details} addPhoneScreen='CardPhone' />
            </View>
          )}
        </ScrollView>
      </View>
